 ...
 */
final class Version20210811100404 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE [user] ADD activate_key NVARCHAR(255)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE [user] DROP COLUMN activate_key');
    }
}
